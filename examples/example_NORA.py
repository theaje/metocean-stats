...
#var_obs, var_mod = lag en liste fra flere modeller (eg. norskyst XX, ..,)
...
#plots.plot_multi_joint_distribution_Hs_Tp_var3(df,var_hs='HS',var_tp='TP',var3='W10',var3_units='m/s',periods=[100],var3_bin=10,threshold_min=100,output_file=folder / 'testing_wind' / 'Hs.Tp.joint.distribution.multi.binned.var3.png')
#plots.plot_multi_joint_distribution_W10_Hs_Tp(df,var_w10='W10',var_hs='HS',var_tp='TP',var3='W10',var3_units='m/s',periods=[100],var3_bin=1,threshold_min=100,output_file=folder / 'testing_wind' / 'W10.Hs.Tp.joint.distribution.png')
...
#Verifications:
#model = ['HS','HS.1','HS.2'] #first in this list will be the reference 
#obs = ['W10','W50','W80','W100','W150'] #observation
#put these in a list: list_samp = []; list_obs=[]
#plots.plot_TaylorDiagram(df, model, obs, NSTD=True, output_file=folder/'Testing_Taylor'/'Taylor_diagram.png')
...
#plots.plot_multi_joint_distribution_Hs_Tp_var3(df,var_hs='HS',var_tp='TP',var3='W10',var3_units='m/s',periods=[100],var3_bin=5,threshold_min=100,output_file=folder / 'Hs.Tp.joint.distribution.multi.binned.var3.png')
